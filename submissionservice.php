...
class ODSubmission_Var {
	...
	var $simpleValue;
	var $nValues = 0;
	var $multipleStringValues;
	var $multipleLongValues;
	var $multipleDoubleValues;
}
...
/*
* Esker ODSubmission_BusinessData Object.
* 
* @access public
*/   
class ODSubmission_BusinessData {
...
/*
* Esker ODSubmission_SubNode Object.
* 
* @access public
*/   
class ODSubmission_SubNode {
...
/*
* Esker ODSubmission_XMLDescription Object.
* 
* @access public
*/   
class ODSubmission_XMLDescription {
...
/*
* Esker ODSubmission_ExtractionResult Object.
* 
* @access public
*/   
class ODSubmission_ExtractionResult {
...
/*
* Esker ODSubmission_BusinessRules Object.
* 
* @access public
*/   
class ODSubmission_BusinessRules {
...
/*
* Esker ODSubmission_ConversionResult Object.
* 
* @access public
*/   
class ODSubmission_ConversionResult {
...
/*
* Esker ConversionParameters Object.
* 
* @access public
*/   
class ODSubmission_ConversionParameters {
...
/*
* Esker ODSubmission_ExtractionParameters Object.
* 
* @access public
*/   
class ODSubmission_ExtractionParameters {
 ...
 * @access public
 */
class ODSubmission_TransportAttachments {
...
/*
* Esker ODSubmission_SessionHeader Object.
* 
* @access public
*/
class ODSubmission_SessionHeader {
